...
function CopyZimoji({ data }: Props) {
  ...
  return (
    <div className="zimoji-copy lg:absolute ml-[6%] z-[103] flex flex-col gap-4 3xl:gap-6">
      <div className="flex gap-4 3xl:gap-6 items-center">
        <img
      ...
      <div className="flex gap-6 3xl:gap-8 items-center">
        <DownloadQr qr={data.qr_code} animateQr={data.qr_code_animated} />
        <button onClick={handleShareClick}>
          <Share
            className={clsx(
              "h-[24px] 3xl:h-[32px] hover:fill-golden",
