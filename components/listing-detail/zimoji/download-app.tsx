...
function DownloadApp() {
  ...
  return (
    <div className="download-app flex flex-col gap-4 3xl:gap-6 w-[237px] 3xl:w-[323px] mx-auto">
      <img
        src="/assets/text/download-scanner.svg"
        className={clsx("w-full", theme === "dark" && "invert")}
        alt=""
      />
      <div className="flex justify-between items-center h-[85px] 3xl:h-[119px]">
        <div className="flex flex-col h-full justify-between w-[114px] 3xl:w-[160px]">
          <img
            src={`/assets/buttons/${
