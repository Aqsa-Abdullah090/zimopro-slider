...
function Description() {
  return (
    <div className="max-w-[700px] text-[11px] px-4 lg:pl-12 3xl:pl-16 mt-3 3xl:mt-4 small-description">
      <p className="normal-case">A beautiful property located in a prime location with all modern
